...
(cl:defmethod cl:initialize-instance :after ((m <SetAmplitude-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAmplitude-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name isella3-srv:<SetAmplitude-request> is deprecated: use isella3-srv:SetAmplitude-request instead.")))

(cl:ensure-generic-function 'amplitude-val :lambda-list '(m))
(cl:defmethod amplitude-val ((m <SetAmplitude-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader isella3-srv:amplitude-val is deprecated.  Use isella3-srv:amplitude instead.")
  (amplitude m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetAmplitude-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAmplitude-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name isella3-srv:<SetAmplitude-response> is deprecated: use isella3-srv:SetAmplitude-response instead.")))
